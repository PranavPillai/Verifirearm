      ...
      <form @submit.prevent="onSubmit">
        <div class="grid-form">
          <div class="form-block">
            <label for="official-name"> Issuing Official</label>
            <input
              required
              type="text"
              ...
              placeholder="e.g Pranav Pillai"
            />
          </div>
          <div class="form-block">
            <label for="reg-number">Official License Number</label>
            <input
              required
              type="text"
          ...
          <div class="form-block">
            <label for="reg-exp-date">Screening expiry date</label>
            <input
              required
              type="date"
              v-model="regExpDate"
...
const { VUE_APP_CRIME_SCHEMA } = process.env;
export default defineComponent({
  ...
  methods: {
    async onSubmit() {
      ...
      const formValues = {
        name: "Your Criminal Background Check",
        firstName: this.firstName,
        lastName: this.lastName,
        licenseNumber: this.licenseNumber,
        regExpDate: this.regExpDate,
        officialName: this.officialName,
        schema: VUE_APP_CRIME_SCHEMA,
